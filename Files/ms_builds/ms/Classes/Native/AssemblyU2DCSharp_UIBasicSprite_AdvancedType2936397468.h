...
struct  AdvancedType_t2936397468 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AdvancedType_t2936397468, ___value___1)); }
