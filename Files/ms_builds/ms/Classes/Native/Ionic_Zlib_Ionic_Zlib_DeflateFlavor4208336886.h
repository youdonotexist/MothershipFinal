...
struct  DeflateFlavor_t4208336886 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DeflateFlavor_t4208336886, ___value___1)); }
