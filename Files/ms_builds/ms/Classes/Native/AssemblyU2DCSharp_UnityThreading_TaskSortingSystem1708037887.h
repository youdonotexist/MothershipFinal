...
struct  TaskSortingSystem_t1708037887 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TaskSortingSystem_t1708037887, ___value___1)); }
