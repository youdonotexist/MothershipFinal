...
struct  CompressionLevel_t3940478795 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CompressionLevel_t3940478795, ___value___1)); }
