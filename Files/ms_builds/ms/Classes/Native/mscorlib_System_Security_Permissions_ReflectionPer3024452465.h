...
struct  ReflectionPermission_t3024452465  : public CodeAccessPermission_t1537136389
{
public:
...
public:
	inline static int32_t get_offset_of_flags_0() { return static_cast<int32_t>(offsetof(ReflectionPermission_t3024452465, ___flags_0)); }
