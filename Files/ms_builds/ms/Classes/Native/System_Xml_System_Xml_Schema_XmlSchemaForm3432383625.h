...
struct  XmlSchemaForm_t3432383625 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(XmlSchemaForm_t3432383625, ___value___1)); }
