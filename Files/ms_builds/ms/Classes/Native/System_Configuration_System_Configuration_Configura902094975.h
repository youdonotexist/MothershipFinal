...
struct  ConfigurationAllowExeDefinition_t902094975 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationAllowExeDefinition_t902094975, ___value___1)); }
