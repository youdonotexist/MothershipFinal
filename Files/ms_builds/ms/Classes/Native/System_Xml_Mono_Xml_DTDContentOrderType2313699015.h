...
struct  DTDContentOrderType_t2313699015 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DTDContentOrderType_t2313699015, ___value___1)); }
