...
struct  CommandState_t2109480998 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CommandState_t2109480998, ___value___1)); }
