...
struct  XmlSchemaUse_t3827175708 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(XmlSchemaUse_t3827175708, ___value___1)); }
