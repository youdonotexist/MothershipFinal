...
struct  TermInfoNumbers_t832752933 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TermInfoNumbers_t832752933, ___value___1)); }
