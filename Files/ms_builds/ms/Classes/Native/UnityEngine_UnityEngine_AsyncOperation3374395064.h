...
struct  AsyncOperation_t3374395064  : public YieldInstruction_t3557331758
{
public:
...
public:
	inline static int32_t get_offset_of_m_Ptr_0() { return static_cast<int32_t>(offsetof(AsyncOperation_t3374395064, ___m_Ptr_0)); }
