...
struct  SslProtocols_t2100950796 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SslProtocols_t2100950796, ___value___1)); }
