...
struct  UpdateCondition_t3642154546 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(UpdateCondition_t3642154546, ___value___1)); }
