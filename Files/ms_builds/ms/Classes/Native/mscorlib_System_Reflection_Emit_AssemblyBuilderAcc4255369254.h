...
struct  AssemblyBuilderAccess_t4255369254 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AssemblyBuilderAccess_t4255369254, ___value___1)); }
