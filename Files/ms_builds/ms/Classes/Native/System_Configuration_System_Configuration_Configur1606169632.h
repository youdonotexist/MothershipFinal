...
struct  ConfigurationPropertyOptions_t1606169632 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationPropertyOptions_t1606169632, ___value___1)); }
