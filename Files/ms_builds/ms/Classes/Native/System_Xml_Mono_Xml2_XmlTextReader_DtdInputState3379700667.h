...
struct  DtdInputState_t3379700667 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DtdInputState_t3379700667, ___value___1)); }
