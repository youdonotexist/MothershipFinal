...
struct  DTDAttributeOccurenceType_t1483234285 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DTDAttributeOccurenceType_t1483234285, ___value___1)); }
