...
struct  XmlSchemaValidity_t1086268151 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(XmlSchemaValidity_t1086268151, ___value___1)); }
