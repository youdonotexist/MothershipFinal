...
struct  ConfigurationElementCollectionType_t4199191211 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationElementCollectionType_t4199191211, ___value___1)); }
