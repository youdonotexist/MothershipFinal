...
struct  TransparencySortMode_t2095715398 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TransparencySortMode_t2095715398, ___value___1)); }
