...
struct  SecTrustResult_t3917437860 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SecTrustResult_t3917437860, ___value___1)); }
