...
struct  KeyContainerPermissionFlags_t1391209357 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(KeyContainerPermissionFlags_t1391209357, ___value___1)); }
