...
struct  ZlibStreamFlavor_t1582004022 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ZlibStreamFlavor_t1582004022, ___value___1)); }
