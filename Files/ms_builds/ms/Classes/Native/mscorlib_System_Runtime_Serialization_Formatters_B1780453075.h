...
struct  ClrTypeMetadata_t1780453075  : public TypeMetadata_t1707658058
{
public:
...
public:
	inline static int32_t get_offset_of_InstanceType_2() { return static_cast<int32_t>(offsetof(ClrTypeMetadata_t1780453075, ___InstanceType_2)); }
