...
struct  XmlUrlResolver_t215921638  : public XmlResolver_t2502213349
{
public:
...
public:
	inline static int32_t get_offset_of_credential_0() { return static_cast<int32_t>(offsetof(XmlUrlResolver_t215921638, ___credential_0)); }
