...
struct  FileIOPermissionAccess_t416300780 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(FileIOPermissionAccess_t416300780, ___value___1)); }
