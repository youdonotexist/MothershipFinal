...
struct  ContextMenu_t3087686619  : public Attribute_t498693649
{
public:
...
public:
	inline static int32_t get_offset_of_m_ItemName_0() { return static_cast<int32_t>(offsetof(ContextMenu_t3087686619, ___m_ItemName_0)); }
