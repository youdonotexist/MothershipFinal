...
struct  ShowCondition_t3591302782 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ShowCondition_t3591302782, ___value___1)); }
