...
public class PoolingSystem<T> where T: class {
	...
	public Transform outOfTheWayParent = null;
	...
	public PoolingSystem (GameObject prefab, int initialSize) : this(prefab, initialSize, null) {}

	public PoolingSystem (GameObject prefab, int initialSize, Transform ootwParent)
	{
		...
		for (int i = 0; i < initialSize; i++)
		{
			...
			if (outOfTheWayParent != null) {
				temp.transform.parent = outOfTheWayParent;
			}
