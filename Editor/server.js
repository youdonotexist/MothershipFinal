...
var express = require('express'),
    ...
    bundle = require('./server/routes/bundle'),
    upgrades = require('./server/routes/upgrades'),
    http = require('http'),
    path = require('path'),
...
app.configure(function(){
  ...
  //app.use(express.static(path.join(__dirname, 'www/metricsbaby')));
...
app.get('/herolist/export/:id', herolist.exportHeroList);
...
app.post('/metrics', metrics.addMetrics);
app.get('/metrics', metrics.getMetrics);

/**
 * Upgrade Types CRUD
 */
app.get('/upgrades/:type', upgrades.getUpgradesForType);
//app.put('/upgrades/:id', upgrades.putUpgradeType);
...
app.get('/latestBundle', bundle.getCurrentBundle);
